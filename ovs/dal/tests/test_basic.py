...
from ovs.dal.hybrids.t_testitem import TestItem
...
class Basic(unittest.TestCase):
    ...
    def test_unique_constraint_composite(self):
        """
        Validates whether the unique constraint works as expected
        """
        item1 = TestItem()
        ...
        item1.other_item_id = 1
        item1.another_item_id = 10
        item1.save()  # Work, its the first item1 with these pointers
        item2 = TestItem()
        item2.name = 'item2'
        item2.description = 'item2'
        item2.other_item_id = 1
